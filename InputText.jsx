const InputText = ({ labelText, description, moreInfo }) => {
  ...
  return (
    <div className={`p-3 flex flex-col  w-full max-w-2xl gap-3  bg-[#ffffffa0]  border border border-2 border-gray-200 rounded-lg  backdrop-blur-3xl ${changeBg()}`}>
